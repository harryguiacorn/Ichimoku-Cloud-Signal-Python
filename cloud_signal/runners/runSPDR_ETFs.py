...
def main(
    ...
    logger.info(f"SPDR ETFs task begins at: {time_start_formatted} [UK]")
    ...
    logger.info(
        f"SPDR ETFs tasks completed at {time_finish_formatted} [UK] (Time elapsed: {time_elapsed})"
    )
