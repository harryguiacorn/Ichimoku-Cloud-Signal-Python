from cloud_signal.mvc.controllers import (
...
def main(
    fetch_symbols_latest_FTSE100=fetch_symbols_latest_FTSE100,
    fetch_FTSE100_1H=fetch_FTSE100_1H,
    fetch_FTSE100_D=fetch_FTSE100_D,
    fetch_FTSE100_W=fetch_FTSE100_W,
    fetch_FTSE100_M=fetch_FTSE100_M,
    fetch_kijun_analysis=fetch_kijun_analysis,
    fetch_Kicker_use_datetime_format=fetch_Kicker_use_datetime_format,
    run_Multi_TimeFrame_Merger_FTSE100=run_Multi_TimeFrame_Merger_FTSE100,
    ...
    logger.info(f"FTSE 100 task begins at: {time_start_formatted} [UK]")
    ...
    chikou_timeframes = [
        ...
        (fetch_FTSE100_D, "data/ftse100/d/", False, "FTSE100-chikou-D", "1D"),
        (fetch_FTSE100_W, "data/ftse100/w/", False, "FTSE100-chikou-W", "1W"),
        (fetch_FTSE100_M, "data/ftse100/m/", False, "FTSE100-chikou-M", "1M"),
    ]
    ...
    GetIchimokuChikouDataAggregator.main(
        "asset_list/FTSE100.csv", chikou_timeframes
    )
    # 3.9 Merge Multi Time Frame Chikou signals
    GetIchimokuChikouDataMultiTFMerger.main(
        "FTSE100", chikou_timeframes, run_Multi_TimeFrame_Merger_FTSE100
    )
    ...
    logger.info(
        "FTSE 100 tasks completed at %s [UK] (Time elapsed: %s)",
